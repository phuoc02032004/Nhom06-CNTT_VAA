...
class ReviewService {
    async createReview(productId, userId, reviewData) {
        ...
        const order = await this.findOrder(productId, userId);
        if (!order) {
        ...
        const newReview = new Review({ ...reviewData, user: userId, product: productId });
        return await newReview.save();
    }

    async findOrder(productId, userId) {
    ...
    async updateReview(id, reviewData, userId) {
