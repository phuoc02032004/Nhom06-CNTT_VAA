...
import FormUpdateCategory from '../Forms/Category/UpdateCategory';
                            ...
                            <tr key={key}>
                                ...
                                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                    <div className="flex items-center space-x-3.5">
                                        ...
                                        <button className="hover:text-primary" onClick={() => handleDelete(category.id)}>
                                            <svg
                                                className="fill-current"
                                                width="18"
                                                height="18"
                                        ...
                                        <button className="hover:text-primary" onClick={() => handleButtonClick(category.id)}>
                                            <svg className="h-5 w-4 text-white-500" width="24" height="24"
            ...
            {showForm && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                    <div className="relative p-6 rounded-md w-3/4 md:w-1/2 lg:w-1/2 xl:w-1/2">
                        ...
                        <FormUpdateCategory id={currentCategoryId} onCategoryUpdate={handleCategoryUpdate} />
                    </div>
                </div>
            )}
        </div>
