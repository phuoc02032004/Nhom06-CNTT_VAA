  ...
  const events = [
    {
      ...
      comments: 0,
      description:
        "YEAR END SALE PARTY - 2018 SỰ KIỆN SALE TRANG SỨC BẠC LỚN TRONG NĂM ĐANG DIỄN RA TẠI 5 CỬA HÀNG CỦA KAT JEWELRY TRÊN TOÀN QUỐC SALE UP TO 40% toàn bộ sản phẩm khi mua tại cửa hàng và online...",
